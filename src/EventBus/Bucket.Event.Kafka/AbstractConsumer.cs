...
namespace Bucket.Event.Kafka
{
    ...
    public abstract class AbstractConsumer<TKey, TValue> : AbstractConsumer, IConsumer<TKey, TValue>
    {
        ...
        public abstract void IncrementalAssign(IEnumerable<TopicPartitionOffset> partitions);
        public abstract void IncrementalAssign(IEnumerable<TopicPartition> partitions);
        public abstract void IncrementalUnassign(IEnumerable<TopicPartition> partitions);
    }
}
